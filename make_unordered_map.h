...
std::unordered_map<
	typename details::map_types<TKey, TValue, Hasher, Args...>::TKey,
	typename details::map_types<TKey, TValue, Hasher, Args...>::TValue,
	typename details::map_types<TKey, TValue, Hasher, Args...>::THasher> make_unordered_map(Args&&... args)
{
	static_assert((std::is_convertible_v<Args, typename details::map_types<TKey, TValue, Hasher, Args...>::TPair> &&...),
		"All arguments must be implicitly convertible to std::pair<TKey, TValue>");

	std::unordered_map<
		typename details::map_types<TKey, TValue, Hasher, Args...>::TKey,
		typename details::map_types<TKey, TValue, Hasher, Args...>::TValue,
		typename details::map_types<TKey, TValue, Hasher, Args...>::THasher> map;
